...
namespace EFCache.Redis
{
    public static class Guard
    {
        ...
        {
            if (value >= dateToPrecede) throw new ArgumentOutOfRangeException(parameterName);
        }
        ...
        public static void GuardAgainstNull<T>(this T value, string parameterName, string extraInformation)
        {
            ...
            if (value == null) throw new ArgumentNullException(parameterName, extraInformation);
        }
        ...
        {
            if (string.IsNullOrEmpty(value)) throw new ArgumentOutOfRangeException(parameterName);
        }
